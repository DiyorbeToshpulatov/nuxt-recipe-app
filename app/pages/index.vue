<template>
  <main>
    <section class="bg-[#f1f1f1]">
      ...
      >
        <div class="flex-1 order-2 text-center lg:text-left">
...
import { type RecipeRsponse } from '~~/types/types';
const { data, error } = await useFetch<RecipeRsponse>(
  'https://dummyjson.com/recipes?limit=24'
);
// definePageMeta({
//   layout: 'login',
// });
...
useSeoMeta({
  ...
  ogImage: '/public/nuxt-course-hero.png',
  ogUrl: `http:localhost:3000`,
  twitterTitle: 'Nuxtcipes',
  twitterDescription: 'Recipes for you to cook!',
  twitterImage: '/public/nuxt-course-hero.png',
  twitterCard: 'summary',
});
</script>
